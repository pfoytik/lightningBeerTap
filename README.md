...
┌──────────────────┐    ┌───────────┐  ┌───────────┐    ┌──────────────┐
│  Raspberry Pi    │    │  Relay 1  │  │  Relay 2  │    │  Solenoids   │
│  Zero W          │    │  (GPIO18) │  │  (GPIO19) │    │              │
│                  │    │           │  │           │    │              │
│  [GPIO Layout]   │    │  [Ctrl]   │  │  [Ctrl]   │    │              │
│                  │    │  S ─────  │  │  S ─────  │    │              │
│  Pin 1  (3V3)    │    │  + ─────  │  │  + ─────  │    │              │
│  Pin 2  (5V) ────┼────┼──┤        │  │           │    │              │
│  Pin 3  (GPIO2)  │    │  - ─────  │  │  - ─────  │    │              │
...
│  Pin 5  (GPIO3)  │    │           │  │           │    │              │
│  Pin 6  (GND)────┼────┼──┤        │  │           │    │              │
│  Pin 7  (GPIO4)  │    │  [Power]  │  │  [Power]  │    │              │
│  Pin 8  (GPIO14) │    │  NO(L)────┼──┼───────────┼────┤ Solenoid 1+  │
│  Pin 9  (GND)    │    │  COM(C)───┼──┼───────┐   │    │              │
│  Pin 10 (GPIO15) │    │  NC(R)    │  │       │   │    │              │
│  Pin 11 (GPIO17) │    │           │  │  NO(L)────┼────┤ Solenoid 2+  │
│  Pin 12 (GPIO18)─┼────┼──► S      │  │  COM(C)───┼────┼──┐           │
│  Pin 13 (GPIO27) │    └───────────┘  │  NC(R)    │    │  │           │
│  Pin 14 (GND)────┼────┐              │           │    │  │           │
│  Pin 15 (GPIO22) │    │              └───────────┘    │  │           │
│  Pin 16 (GPIO23)─┼──┐ │                               │  │           │
